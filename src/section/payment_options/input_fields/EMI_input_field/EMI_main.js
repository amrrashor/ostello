            ...
            <div>
                <div>
                    ...
                    {d.DebitCardEmi.map(dc => (
                            <div  onClick={ dc.active ? ()=>handleActive("AvailableEmi"):""} key={dc.id} className={ dc.active === false ? "cursor-pointer select-none flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3" : "cursor-pointer flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3"}>
                ...
                <div>
                    ...
                    {d.CardLessEmi.map(cl => (
                        <div onClick={ cl.active ? ()=>handleActive("AvailableEmi"):""} key={cl.id} className={ cl.active === false ? "cursor-pointer select-none flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3" : "cursor-pointer flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3"}>
                ...
                <div>
                    ...
                    {d.CreditCardEmi.map(cc => (
                        <div onClick={ cc.active ? ()=>handleActive("AvailableEmi"):""} key={cc.id} className={ cc.active === false ? "select-none flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3 cursor-pointer" : "cursor-pointer flex justify-between w-full p-5 rounded-lg border border-gray-300 my-3"}>
